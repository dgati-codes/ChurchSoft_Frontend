    ...
    <div className="flex min-h-screen bg-[#F6F8FC] font-[DM Sans]"> 
      <main className="flex-1 mt-10">
        <div className="grid grid-cols-4 gap-6 mb-4">
          <Stat icon={<Users className="w-7 h-7 text-[#43A501] bg-green-100 p-1.5 rounded-lg" />} title="Total Members" value="25,000" color="green" />
          <Stat icon={<User className="w-7 h-7 text-[#06A6DB] bg-blue-100 p-1.5 rounded-lg"/>} title="New Members" value="300" color="blue" />
          <Stat icon={<TrendingUp  className="w-7 h-7 text-[#9600D6] bg-violet-100 p-1.5 rounded-lg"/>} title="Average Attendance" value="450" color="purple" />
          <Stat icon={<Banknote  className="w-7 h-7 text-[#FF8605] bg-orange-100 p-1.5 rounded-lg" />} title="Average Monthly Giving" value="GHS 20K" color="orange" />
        </div>
          ...
          <div className="bg-white rounded-2xl p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="flex gap-2">
                <button className="w-8 h-8 rounded-full bg-[#EEF2FF] flex items-center justify-center"><ChevronLeft size={16} /></button>
                <button className="w-8 h-8 rounded-full bg-[#EEF2FF] flex items-center justify-center"><ChevronRight size={16} /></button>
              </div>
            </div>

            <div className="flex gap-4">
              <EventCard  title="Convention" location="Sarbah Hall, UG" date="4th April 2026 - 10th April 2026" />
              <EventCard  title="PPASS" location="The Headquarters" date="15th April 2026 - 17th April 2026" />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl p-6">
            ...
            <p className="text-[13px] text-gray-500 mb-4">Monthly attendance growth over the year</p>
          ...
          <div className="bg-white  rounded-2xl p-6">
            ...
            <NewsItem title="GCCI has a new President!" image="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=880&q=80" parag="The Great Commission church has elected Rev. S.V. Ansah as the new president. Read More"/>            
            <NewsItem title="GCCI makes a donation" parag="The GCCI makes a massive donation to the deaf and blind in the Central region. Read More" image="https://www.shutterstock.com/image-photo/male-volunteer-giving-food-donations-260nw-2467626911.jpg" />
            <NewsItem title="New Building, New Members!!!" parag="Massive building put up by the Great Commission church. Read More" image="https://th.bing.com/th/id/R.6fa09451c69ff1379a67dea9d98fd694?rik=0VQM%2fdM2LxnuOw&riu=http%3a%2f%2fhiddenarchitecture.net%2fwp-content%2fuploads%2f2015%2f05%2fewr-1024x1024.jpg&ehk=1vt2%2fSWqgB%2bd2egxY3QuCQL5EtMch759cLMLbZjlhwU%3d&risl=&pid=ImgRaw&r=0" />
          </div>
...
function EventCard({ title, location, date }) {
  return (
    <div className="flex flex-col bg-[#EEF2FF] rounded-xl p-6">
      <h4 className="text-[15px] font-semibold mb-2 text-center bg-white px-2 py-1 rounded-full">{title}</h4>
...
function Ministry({ title, leader, count }) {
  return (
    <div className="flex items-center justify-between border rounded-xl p-4">
      ...
      <div className="flex items-center gap-2 text-[14px]"> <Users size={16} /> {count}</div>
    </div>
  );
}
